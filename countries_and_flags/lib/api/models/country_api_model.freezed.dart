...
mixin _$CountryApiModel {
  FlagsNameModel get name => throw _privateConstructorUsedError;
  FlagsImageModel get flags => throw _privateConstructorUsedError;
...
abstract class $CountryApiModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({FlagsNameModel name, FlagsImageModel flags, String cca2});

  $FlagsNameModelCopyWith<$Res> get name;
  $FlagsImageModelCopyWith<$Res> get flags;
}
...
class _$CountryApiModelCopyWithImpl<$Res, $Val extends CountryApiModel>
  ...
  @pragma('vm:prefer-inline')
  $FlagsNameModelCopyWith<$Res> get name {
    return $FlagsNameModelCopyWith<$Res>(_value.name, (value) {
  ...
  @pragma('vm:prefer-inline')
  $FlagsImageModelCopyWith<$Res> get flags {
    return $FlagsImageModelCopyWith<$Res>(_value.flags, (value) {
...
class _$CountryApiModelImpl
  ...
  @override
  final FlagsNameModel name;
  @override
  final FlagsImageModel flags;
  @override
  final String cca2;
...
abstract class _CountryApiModel implements CountryApiModel {
  const factory _CountryApiModel(
      {required final FlagsNameModel name,
      required final FlagsImageModel flags,
  ...
  @override
  FlagsNameModel get name;
  @override
  FlagsImageModel get flags;
  @override
  String get cca2;
